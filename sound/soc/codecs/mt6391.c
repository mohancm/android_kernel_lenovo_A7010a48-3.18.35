			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = codec_data->device_volume[MT6391_VOL_HPOUTL];
	return 0;
}
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = codec_data->device_volume[MT6391_VOL_HPOUTR];
	return 0;
}
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = codec_data->device_volume[MT6391_VOL_HSOUTL];
	return 0;
}
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = codec_data->device_volume[MT6391_VOL_SPKL];
	return 0;
}
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = codec_data->device_volume[MT6391_VOL_SPKR];
	return 0;
}
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	pr_debug("%s\n", __func__);
	codec_data->speaker_channel_sel = ucontrol->value.enumerated.item[0];
	return 0;
}
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = codec_data->speaker_channel_sel;
	return 0;
}
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	if (codec_data->speaker_mode == MT6391_CLASS_AB)
		ucontrol->value.enumerated.item[0] = (reg_value & 0xA000) ? 1 : 0;
	else
		ucontrol->value.enumerated.item[0] = (reg_value & 0x5000) ? 1 : 0;
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = (reg_value & 0x8000) ? 1 : 0;
	return 0;
}
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = codec_data->device_mux[MT6391_MUX_IN_PREAMP_1];
	return 0;
}
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	else if (ucontrol->value.enumerated.item[0] != 0)
		pr_warn("%s unexpected value %ld", __func__, ucontrol->value.enumerated.item[0]);

	pr_debug("%s done\n", __func__);
	codec_data->device_mux[MT6391_MUX_IN_PREAMP_1] = ucontrol->value.enumerated.item[0];
	return 0;
}
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = codec_data->device_mux[MT6391_MUX_IN_PREAMP_2];
	return 0;
}
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	pr_debug("%s done\n", __func__);
	codec_data->device_mux[MT6391_MUX_IN_PREAMP_2] = ucontrol->value.enumerated.item[0];
	return 0;
}
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = codec_data->codec_loopback_type;
	return 0;
}
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	long set_value = ucontrol->value.enumerated.item[0];
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = codec_data->dac_sgen_switch;
	return 0;
}
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	if (codec_data->dac_sgen_switch == ucontrol->value.enumerated.item[0]) {
	...
	codec_data->dac_sgen_switch = ucontrol->value.enumerated.item[0];
	return 0;
}
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = codec_data->adc_sgen_switch;
	return 0;
}
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	if (codec_data->adc_sgen_switch == ucontrol->value.enumerated.item[0]) {
	...
	codec_data->adc_sgen_switch = ucontrol->value.enumerated.item[0];
	return 0;
}
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	if (codec_data->sample_rate[MT6391_ADDA_DAC] == 48000)
		ucontrol->value.enumerated.item[0] = DAC_FREQ_48000;
	else if (codec_data->sample_rate[MT6391_ADDA_DAC] == 44100)
		ucontrol->value.enumerated.item[0] = DAC_FREQ_44100;
	else if (codec_data->sample_rate[MT6391_ADDA_DAC] == 32000)
		ucontrol->value.enumerated.item[0] = DAC_FREQ_32000;
	else if (codec_data->sample_rate[MT6391_ADDA_DAC] == 24000)
		ucontrol->value.enumerated.item[0] = DAC_FREQ_24000;
	else if (codec_data->sample_rate[MT6391_ADDA_DAC] == 22050)
		ucontrol->value.enumerated.item[0] = DAC_FREQ_22050;
	else if (codec_data->sample_rate[MT6391_ADDA_DAC] == 16000)
		ucontrol->value.enumerated.item[0] = DAC_FREQ_16000;
	else if (codec_data->sample_rate[MT6391_ADDA_DAC] == 12000)
		ucontrol->value.enumerated.item[0] = DAC_FREQ_12000;
	else if (codec_data->sample_rate[MT6391_ADDA_DAC] == 11025)
		ucontrol->value.enumerated.item[0] = DAC_FREQ_11025;
	else if (codec_data->sample_rate[MT6391_ADDA_DAC] == 8000)
		ucontrol->value.enumerated.item[0] = DAC_FREQ_8000;
	else
		ucontrol->value.enumerated.item[0] = DAC_FREQ_48000;
	return 0;
}
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	if (ucontrol->value.enumerated.item[0] == DAC_FREQ_48000)
		codec_data->sample_rate[MT6391_ADDA_DAC] = 48000;
	else if (ucontrol->value.enumerated.item[0] == DAC_FREQ_44100)
		codec_data->sample_rate[MT6391_ADDA_DAC] = 44100;
	else if (ucontrol->value.enumerated.item[0] == DAC_FREQ_32000)
		codec_data->sample_rate[MT6391_ADDA_DAC] = 32000;
	else if (ucontrol->value.enumerated.item[0] == DAC_FREQ_24000)
		codec_data->sample_rate[MT6391_ADDA_DAC] = 24000;
	else if (ucontrol->value.enumerated.item[0] == DAC_FREQ_22050)
		codec_data->sample_rate[MT6391_ADDA_DAC] = 22050;
	else if (ucontrol->value.enumerated.item[0] == DAC_FREQ_16000)
		codec_data->sample_rate[MT6391_ADDA_DAC] = 16000;
	else if (ucontrol->value.enumerated.item[0] == DAC_FREQ_12000)
		codec_data->sample_rate[MT6391_ADDA_DAC] = 12000;
	else if (ucontrol->value.enumerated.item[0] == DAC_FREQ_11025)
		codec_data->sample_rate[MT6391_ADDA_DAC] = 11025;
	else if (ucontrol->value.enumerated.item[0] == DAC_FREQ_8000)
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	if (codec_data->sample_rate[MT6391_ADDA_ADC] == 48000)
		ucontrol->value.enumerated.item[0] = ADC_FREQ_48000;
	else if (codec_data->sample_rate[MT6391_ADDA_ADC] == 32000)
		ucontrol->value.enumerated.item[0] = ADC_FREQ_32000;
	else if (codec_data->sample_rate[MT6391_ADDA_ADC] == 16000)
		ucontrol->value.enumerated.item[0] = ADC_FREQ_16000;
	else if (codec_data->sample_rate[MT6391_ADDA_ADC] == 8000)
		ucontrol->value.enumerated.item[0] = ADC_FREQ_8000;
	else
		ucontrol->value.enumerated.item[0] = ADC_FREQ_48000;
	return 0;
}
			...
			struct snd_ctl_elem_value *ucontrol)
{
	...
	if (ucontrol->value.enumerated.item[0] == ADC_FREQ_48000)
		codec_data->sample_rate[MT6391_ADDA_ADC] = 48000;
	else if (ucontrol->value.enumerated.item[0] == ADC_FREQ_32000)
		codec_data->sample_rate[MT6391_ADDA_ADC] = 32000;
	else if (ucontrol->value.enumerated.item[0] == ADC_FREQ_16000)
		codec_data->sample_rate[MT6391_ADDA_ADC] = 16000;
	else if (ucontrol->value.enumerated.item[0] == ADC_FREQ_8000)
