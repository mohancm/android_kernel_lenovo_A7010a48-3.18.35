			  ...
			  struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = wm8994->mbc_ena[mbc];
			  ...
			  struct snd_ctl_elem_value *ucontrol)
{
	...
	if (wm8994->mbc_ena[mbc] == ucontrol->value.enumerated.item[0])
		return 0;
	...
	wm8994->mbc_ena[mbc] = ucontrol->value.enumerated.item[0];
			  ...
			  struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = wm8994->vss_ena[vss];
			  ...
			  struct snd_ctl_elem_value *ucontrol)
{
	...
	if (wm8994->vss_ena[vss] == ucontrol->value.enumerated.item[0])
		return 0;
	...
	wm8994->vss_ena[vss] = ucontrol->value.enumerated.item[0];
			  ...
			  struct snd_ctl_elem_value *ucontrol)
{
	...
	if (hpf < 3)
		ucontrol->value.enumerated.item[0] = wm8994->hpf1_ena[hpf % 3];
	else
		ucontrol->value.enumerated.item[0] = wm8994->hpf2_ena[hpf % 3];
			  ...
			  struct snd_ctl_elem_value *ucontrol)
{
	...
	if (hpf < 3)
		wm8994->hpf1_ena[hpf % 3] = ucontrol->value.enumerated.item[0];
	else
		wm8994->hpf2_ena[hpf % 3] = ucontrol->value.enumerated.item[0];

	wm8958_dsp_apply(codec, hpf % 3, ucontrol->value.enumerated.item[0]);
			  ...
			  struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = wm8994->enh_eq_ena[eq];
			  ...
			  struct snd_ctl_elem_value *ucontrol)
{
	...
	if (wm8994->enh_eq_ena[eq] == ucontrol->value.enumerated.item[0])
		return 0;
	...
	wm8994->enh_eq_ena[eq] = ucontrol->value.enumerated.item[0];

	wm8958_dsp_apply(codec, eq, ucontrol->value.enumerated.item[0]);
