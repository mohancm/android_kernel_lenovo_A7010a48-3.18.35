			     ...
			     struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = mDac_Sinegen;
	return 0;
}
...
{
	pr_warn("%s\n", __func__);
	ucontrol->value.enumerated.item[0] = mDac_SampleRate;
	return 0;
}
			      ...
			      struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = mEnableSidetone;
	return 0;
}
				   ...
				   struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = mModemPcm_ASRC_on;
	return 0;
}
#endif
				   ...
				   struct snd_ctl_elem_value *ucontrol)
{
	...
	mModemPcm_ASRC_on = (bool)ucontrol->value.enumerated.item[0];
...
{
	pr_warn("%s()\n", __func__);
	ucontrol->value.enumerated.item[0] = AudDrvSuspend_ipoh_Status;
	return 0;
}
				  ...
				  struct snd_ctl_elem_value *ucontrol)
{
	...
	AudDrvSuspend_ipoh_Status = ucontrol->value.enumerated.item[0];
	return 0;
}
...
{
	pr_warn("Audio_SideTone_Get = %d\n", mAudio_Mode);
	ucontrol->value.enumerated.item[0] = mAudio_Mode;
	return 0;
}
			  ...
			  struct snd_ctl_elem_value *ucontrol)
{
	...
	mAudio_Mode = ucontrol->value.enumerated.item[0];
	return 0;
}
				...
				struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] =   mHplOffset;
	AudDrv_Clk_Off();
#else
	ucontrol->value.enumerated.item[0] = 2048;
#endif
	return 0;
}
...
#ifndef EFUSE_HP_TRIM
	pr_warn("%s()\n", __func__);
	mHplOffset = ucontrol->value.enumerated.item[0];
	SetHplTrimOffset(mHplOffset);
#else
	mHplOffset = ucontrol->value.enumerated.item[0];
#endif
				...
				struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] =   mHprOffset;
	AudDrv_Clk_Off();
#else
	ucontrol->value.enumerated.item[0] = 2048;
#endif
...
#ifndef EFUSE_HP_TRIM
	pr_warn("%s()\n", __func__);
	mHprOffset = ucontrol->value.enumerated.item[0];
	SetHprTrimOffset(mHprOffset);
#else
	mHprOffset = ucontrol->value.enumerated.item[0];
#endif
...
{
	pr_warn("%s()\n", __func__);
	ucontrol->value.enumerated.item[0] = m_Anc_State;
	return 0;
}
...
{
	pr_warn("%s()\n", __func__);
	EnAble_Anc_Path(ucontrol->value.enumerated.item[0]);
	m_Anc_State = ucontrol->value.enumerated.item[0];
	return 0;
}
