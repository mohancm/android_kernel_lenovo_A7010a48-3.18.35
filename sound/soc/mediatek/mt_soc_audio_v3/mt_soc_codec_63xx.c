...
static int Audio_AmpL_Set(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	...
	if ((ucontrol->value.enumerated.item[0] == true)
	    && (mCodec_data->mAudio_Ana_DevicePower[AUDIO_ANALOG_DEVICE_OUT_HEADSETL] == false)) {
		Audio_Amp_Change(AUDIO_ANALOG_CHANNELS_LEFT1, true);
		mCodec_data->mAudio_Ana_DevicePower[AUDIO_ANALOG_DEVICE_OUT_HEADSETL] =
		    ucontrol->value.enumerated.item[0];
	} else if ((ucontrol->value.enumerated.item[0] == false)
		   && (mCodec_data->mAudio_Ana_DevicePower[AUDIO_ANALOG_DEVICE_OUT_HEADSETL] ==
		       true)) {
		mCodec_data->mAudio_Ana_DevicePower[AUDIO_ANALOG_DEVICE_OUT_HEADSETL] =
		    ucontrol->value.enumerated.item[0];
...
{
	mutex_lock(&Ana_Ctrl_Mutex);
	Speaker_mode = ucontrol->value.enumerated.item[0];
	mutex_unlock(&Ana_Ctrl_Mutex);
	return 0;
}
...
static int Audio_Speaker_Class_Get(struct snd_kcontrol *kcontrol,
				   struct snd_ctl_elem_value *ucontrol)
{
	ucontrol->value.enumerated.item[0] = Speaker_mode;
	return 0;
}
...
static int Audio_Speaker_Pga_Gain_Set(struct snd_kcontrol *kcontrol,
				      struct snd_ctl_elem_value *ucontrol)
{
	Speaker_pga_gain = ucontrol->value.enumerated.item[0];
				    ...
				    struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = mSpeaker_Ocflag;
	return 0;
}
...
static int Audio_Speaker_Pga_Gain_Get(struct snd_kcontrol *kcontrol,
				      struct snd_ctl_elem_value *ucontrol)
{
	ucontrol->value.enumerated.item[0] = Speaker_pga_gain;
	return 0;
}
...
static int Audio_Speaker_Current_Sensing_Get(struct snd_kcontrol *kcontrol,
					     struct snd_ctl_elem_value *ucontrol)
{
	ucontrol->value.enumerated.item[0] = (Ana_Get_Reg(SPK_CON12) >> 15) & 0x01;
	return 0;
}
...
static int Audio_Speaker_Current_Sensing_Peak_Detector_Get(struct snd_kcontrol *kcontrol,
							   struct snd_ctl_elem_value *ucontrol)
{
	ucontrol->value.enumerated.item[0] = (Ana_Get_Reg(SPK_CON12) >> 14) & 0x01;
	return 0;
}
...
#ifdef CONFIG_MTK_SPEAKER
	ucontrol->value.enumerated.item[0] = Audio_AuxAdcData_Get_ext();
...
{
	dAuxAdcChannel = ucontrol->value.enumerated.item[0];
...
static int Lineout_PGAL_Get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = mCodec_data->mAudio_Ana_Volume[AUDIO_ANALOG_VOLUME_SPKL];
	return 0;
}
...
static int Lineout_PGAL_Set(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	...
	mCodec_data->mAudio_Ana_Volume[AUDIO_ANALOG_VOLUME_SPKL] = ucontrol->value.enumerated.item[0];
	return 0;
}
...
static int Lineout_PGAR_Get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = mCodec_data->mAudio_Ana_Volume[AUDIO_ANALOG_VOLUME_SPKR];
	return 0;
}
...
static int Lineout_PGAR_Set(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	...
	mCodec_data->mAudio_Ana_Volume[AUDIO_ANALOG_VOLUME_SPKR] = ucontrol->value.enumerated.item[0];
	return 0;
}
				  ...
				  struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = mHp_Impedance;
	return 0;
...
static int Audio_Hp_Impedance_Set(struct snd_kcontrol *kcontrol,
				  struct snd_ctl_elem_value *ucontrol)
{
	mHp_Impedance = ucontrol->value.enumerated.item[0];
...
static int Aud_Clk_Buf_Get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = audck_buf_Count;
	return 0;
}
...
static int Audio_ADC1_Sel_Get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = mCodec_data->mAudio_Ana_Mux[AUDIO_ANALOG_MUX_IN_MIC1];
	return 0;
}
...
static int Audio_ADC1_Sel_Set(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	...
	pr_warn("%s() done\n", __func__);
	mCodec_data->mAudio_Ana_Mux[AUDIO_ANALOG_MUX_IN_MIC1] = ucontrol->value.enumerated.item[0];
	return 0;
}
...
static int Audio_ADC2_Sel_Get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = mCodec_data->mAudio_Ana_Mux[AUDIO_ANALOG_MUX_IN_MIC2];
	return 0;
}
...
static int Audio_ADC2_Sel_Set(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	...
	else if (ucontrol->value.enumerated.item[0] == 2)	/* Right preamp */
		Ana_Set_Reg(AUDENC_ANA_CON1, (0x0002 << 9), 0x0600);
	else
		pr_warn("%s() warning\n ", __func__);

	pr_warn("%s() done\n", __func__);
	mCodec_data->mAudio_Ana_Mux[AUDIO_ANALOG_MUX_IN_MIC2] = ucontrol->value.enumerated.item[0];
	return 0;
}
...
static int Audio_MicSource1_Get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	pr_warn("Audio_MicSource1_Get = %d\n",
	       mCodec_data->mAudio_Ana_Mux[AUDIO_MICSOURCE_MUX_IN_1]);
	ucontrol->value.enumerated.item[0] = mCodec_data->mAudio_Ana_Mux[AUDIO_MICSOURCE_MUX_IN_1];
	return 0;
}
...
static int Audio_MicSource1_Set(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	...
	mCodec_data->mAudio_Ana_Mux[AUDIO_MICSOURCE_MUX_IN_1] = ucontrol->value.enumerated.item[0];
				      ...
				      struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = mAudio_Analog_Mic1_mode;
	return 0;
}
				      ...
				      struct snd_ctl_elem_value *ucontrol)
{
	...
	mAudio_Analog_Mic1_mode = ucontrol->value.enumerated.item[0];
	pr_warn("%s() mAudio_Analog_Mic1_mode = %d\n", __func__, mAudio_Analog_Mic1_mode);
	return 0;
}
				      ...
				      struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = mAudio_Analog_Mic2_mode;
	return 0;
}
				      ...
				      struct snd_ctl_elem_value *ucontrol)
{
	...
	mAudio_Analog_Mic2_mode = ucontrol->value.enumerated.item[0];
				      ...
				      struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = mAudio_Analog_Mic3_mode;
	return 0;
}
				      ...
				      struct snd_ctl_elem_value *ucontrol)
{
	...
	mAudio_Analog_Mic3_mode = ucontrol->value.enumerated.item[0];
				      ...
				      struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = mAudio_Analog_Mic4_mode;
	return 0;
}
				      ...
				      struct snd_ctl_elem_value *ucontrol)
{
	...
	mAudio_Analog_Mic4_mode = ucontrol->value.enumerated.item[0];
				    ...
				    struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = mAdc_Power_Mode;
	return 0;
}
				    ...
				    struct snd_ctl_elem_value *ucontrol)
{
	...
	mAdc_Power_Mode = ucontrol->value.enumerated.item[0];
					 ...
					 struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = mAudio_Vow_Analog_Func_Enable;
	return 0;
}
					 ...
					 struct snd_ctl_elem_value *ucontrol)
{
	...
	mAudio_Vow_Analog_Func_Enable = ucontrol->value.enumerated.item[0];
					     ...
					     struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = mAudio_Vow_Digital_Func_Enable;
	return 0;
}
					     ...
					     struct snd_ctl_elem_value *ucontrol)
{
	...
	mAudio_Vow_Digital_Func_Enable = ucontrol->value.enumerated.item[0];
					 ...
					 struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = mAudio_VOW_Mic_type;
	return 0;
}
					 ...
					 struct snd_ctl_elem_value *ucontrol)
{
	...
	mAudio_VOW_Mic_type = ucontrol->value.enumerated.item[0];
...
static int Audio_Vow_Cfg0_Set(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	...
	/* Ana_Set_Reg(AFE_VOW_CFG0, ucontrol->value.enumerated.item[0], 0xffff); */
	reg_AFE_VOW_CFG0 = ucontrol->value.enumerated.item[0];
	return 0;
}
...
{
	pr_warn("%s()  = %d\n", __func__, ucontrol->value.enumerated.item[0]);
	/* Ana_Set_Reg(AFE_VOW_CFG1, ucontrol->value.enumerated.item[0], 0xffff); */
	reg_AFE_VOW_CFG1 = ucontrol->value.enumerated.item[0];
	return 0;
}
...
{
	pr_warn("%s()  = %d\n", __func__, ucontrol->value.enumerated.item[0]);
	/* Ana_Set_Reg(AFE_VOW_CFG2, ucontrol->value.enumerated.item[0], 0xffff); */
	reg_AFE_VOW_CFG2 = ucontrol->value.enumerated.item[0];
	return 0;
}
...
{
	pr_warn("%s()  = %d\n", __func__, ucontrol->value.enumerated.item[0]);
	/* Ana_Set_Reg(AFE_VOW_CFG3, ucontrol->value.enumerated.item[0], 0xffff); */
	reg_AFE_VOW_CFG3 = ucontrol->value.enumerated.item[0];
	return 0;
}
...
{
	pr_warn("%s()  = %d\n", __func__, ucontrol->value.enumerated.item[0]);
	/* Ana_Set_Reg(AFE_VOW_CFG4, ucontrol->value.enumerated.item[0], 0xffff); */
	reg_AFE_VOW_CFG4 = ucontrol->value.enumerated.item[0];
	return 0;
}
...
{
	pr_warn("%s()  = %d\n", __func__, ucontrol->value.enumerated.item[0]);
	/* Ana_Set_Reg(AFE_VOW_CFG5, ucontrol->value.enumerated.item[0], 0xffff); */
	reg_AFE_VOW_CFG5 = ucontrol->value.enumerated.item[0];
	return 0;
}
...
{
	pr_warn("%s()\n", __func__);
	ucontrol->value.enumerated.item[0] = Pmic_Loopback_Type;
	return 0;
}
...
static int Pmic_Loopback_Set(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	...
	if (ucontrol->value.enumerated.item[0] == 0) { /* disable pmic lpbk */
		...
		ClsqEnable(false);
		audckbufEnable(false);
	} else if (ucontrol->value.enumerated.item[0] > 0) { /* enable pmic lpbk */
		audckbufEnable(true);
		ClsqEnable(true);
		Topck_Enable(true);
		...
		if (ucontrol->value.enumerated.item[0] == 1) { /* pmic lpbk 3 DL44 UL48*/
		...
		} else if (ucontrol->value.enumerated.item[0] == 2) { /* pmic lpbk 3 DL48 UL48*/
	...
	pr_warn("%s() done\n", __func__);
	Pmic_Loopback_Type = ucontrol->value.enumerated.item[0];
	return 0;
}
...
{
	pr_warn("%s()\n", __func__);
	ucontrol->value.enumerated.item[0] = SineTable_UL2_flag;
	return 0;
}
...
{
	pr_warn("%s()\n", __func__);
	ucontrol->value.enumerated.item[0] = SineTable_DAC_HP_flag;
	return 0;
}
...
{
	pr_warn("%s()\n", __func__);
	ucontrol->value.enumerated.item[0] = DAC_LOOP_DAC_HS_flag;
	return 0;
}
...
static int ADC_LOOP_DAC_HS_Set(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	pr_warn("%s()\n", __func__);
	if (ucontrol->value.enumerated.item[0]) {
		DAC_LOOP_DAC_HS_flag = ucontrol->value.enumerated.item[0];
...
{
	pr_warn("%s()\n", __func__);
	ucontrol->value.enumerated.item[0] = DAC_LOOP_DAC_HP_flag;
	return 0;
}
...
static int ADC_LOOP_DAC_HP_Set(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	...
	pr_warn("%s()\n", __func__);
	if (ucontrol->value.enumerated.item[0]) {
		DAC_LOOP_DAC_HP_flag = ucontrol->value.enumerated.item[0];
...
{
	pr_warn("%s()\n", __func__);
	ucontrol->value.enumerated.item[0] = Voice_Call_DAC_DAC_HS_flag;
	return 0;
}
