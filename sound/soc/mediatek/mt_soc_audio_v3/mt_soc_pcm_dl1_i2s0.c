				  ...
				  struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = mi2s0_sidegen_control;
	return 0;
}
				  ...
				  struct snd_ctl_elem_value *ucontrol)
{
	...
	mi2s0_sidegen_control = ucontrol->value.enumerated.item[0];
				   ...
				   struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = mi2s0_hdoutput_control;
	return 0;
}
				   ...
				   struct snd_ctl_elem_value *ucontrol)
{
	...
	AudDrv_Clk_On();
	mi2s0_hdoutput_control = ucontrol->value.enumerated.item[0];
#if 0
					   ...
					   struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = mi2s0_extcodec_echoref_control;
	return 0;
}
					   ...
					   struct snd_ctl_elem_value *ucontrol)
{
	...
	mi2s0_extcodec_echoref_control = ucontrol->value.enumerated.item[0];
	return 0;
}
