				   ...
				   struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = mfm_i2s_Volume;
	return 0;
...
static int Audio_fm_i2s_Volume_Set(struct snd_kcontrol *kcontrol,
				   struct snd_ctl_elem_value *ucontrol)
{
	mfm_i2s_Volume = ucontrol->value.enumerated.item[0];
			     ...
			     struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.enumerated.item[0] = mAudio_Wcn_Cmb;
#endif
	return 0;
}
...
{
#if 0/* temp mark for early porting */
	mAudio_Wcn_Cmb = ucontrol->value.enumerated.item[0];
